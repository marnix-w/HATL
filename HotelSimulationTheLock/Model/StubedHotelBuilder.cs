    ...
    public class StubedHotelBuilder : IHotelBuilder
    {
        ...
        public List<IArea> BuildHotel<T>(T file, SettingsModel settings)
        {
            areas = new List<IArea>
            {
                ...
                new Room() { ID = 13, Position = new Point(1, 2), Classification = 5, Art = Properties.Resources.room_five_star_open },
                new Room() { ID = 14, Position = new Point(3, 2), Classification = 4, Art = Properties.Resources.room_four_star_open },
                new Room() { ID = 15, Position = new Point(3, 3), Classification = 3, Art = Properties.Resources.room_three_star_open },
                new Room() { ID = 16, Position = new Point(5, 2), Classification = 1, Art = Properties.Resources.room_one_star_open },
                new Room() { ID = 17, Position = new Point(5, 2), Classification = 1, Art = Properties.Resources.room_one_star_open },
                new Room() { ID = 18, Position = new Point(5, 3), Classification = 2, Art = Properties.Resources.room_two_star_open },
                new Room() { ID = 19, Position = new Point(5, 3), Classification = 2, Art = Properties.Resources.room_two_star_open },
